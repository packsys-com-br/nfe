...
class WSCancelamento implements DFLog {
    ...
    private NFEnviaEventoCancelamento gerarDadosCancelamento(final String chaveAcesso, final String numeroProtocolo, final String motivo, final boolean proxy, final String host, final String porta, int numeroSequencial) {
